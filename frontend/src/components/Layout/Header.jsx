                        ...
                        >
                            <form onSubmit={handleSearchSubmit} className="relative w-full">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 bg-slate-700/50 border border-slate-600/50 rounded-lg focus:outline-none focus:ring-2   transition-all placeholder-slate-400 text-sm  duration-500" //focus:ring-blue-400/50 focus:border-blue-400/50
                                />
                            </form>
                        </motion.div>
                    )}
                        ...
                        >
                            <form onSubmit={handleSearchSubmit} className="flex-1 flex items-center space-x-3">
                                ...
                                <input
                                    ...
                                    value={searchQuery}
                                    onChange={(e) => setSearchQuery(e.target.value)}
                                    className="flex-1 bg-slate-700/50 border border-slate-400 rounded-lg px-3 py-2 text-white placeholder-slate-400 focus:outline-none focus:ring-0 focus:border-blue-400  text-lg transition-all duration-200"
                                />
                                <motion.button
                                    type="button"
