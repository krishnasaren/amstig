...
`;
    ...
    const targetPages = [
        ...
        { url: 'http://localhost:3000/index', name: 'index' },
        { url: 'http://localhost:3000/api/quiz', name: 'quiz' },
        
        // Path traversal attempts
        { url: 'http://localhost:3000/static/../../flag.txt', name: 'flag-traversal' },
        { url: 'http://localhost:3000/static/../package.json', name: 'package' },
        { url: 'http://localhost:3000/static/../bot.js', name: 'bot-source' },
        
        // Possible hidden pages
        { url: 'http://localhost:3000/admin', name: 'admin' },
        { url: 'http://localhost:3000/flag', name: 'flag-page' },
        { url: 'http://localhost:3000/secret', name: 'secret' },
        { url: 'http://localhost:3000/internal', name: 'internal' },
        
        // Quiz variations
        { url: 'http://localhost:3000/quiz', name: 'quiz-page' },
        { url: 'http://localhost:3000/quiz.json', name: 'quiz-json' },
        
        // API endpoints
        { url: 'http://localhost:3000/api', name: 'api-root' },
        { url: 'http://localhost:3000/api/flag', name: 'api-flag' },
        { url: 'http://localhost:3000/api/admin', name: 'api-admin' }
    ];
